/**
 * SinwanJS Release Metadata — from 1.0.0 to 1.3.2
 */
...
describe("release metadata", () => {
  /**
   * Publishes package version 1.3.2
   */
  it("publishes package version 1.3.2", async () => {
  ...
  /**
   * Uses a 1.3.2 changelog entry without removed patch entries
   */
  it("uses a 1.3.2 changelog entry without removed patch entries", async () => {
